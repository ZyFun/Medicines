...
class WelcomeViewController: UIViewController {
    ...
    private func configure() {
        ...
        let subs = [
            ...
            "В будующем планируется много дополнений, если у тебя есть идеи по доработке, обязательно пиши об этом в отзывах. Учту всё и постараюсь сделать по твоим пожеланиям. \n\nНа данный момент это самая первая версия приложения и оно будет развиваться. Добавятся новые функции и со временем сделаю более красивый дизайн. Сейчас работа больше идет над функционалом. Я только учусь и твой отзыв очень поможет мне в этом не лёгком деле 🤓"
        ]
