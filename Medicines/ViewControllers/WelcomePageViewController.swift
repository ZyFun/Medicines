...
class WelcomePageViewController: UIPageViewController {
    ...
    private let descriptionWelcome = [
        ...
        "В будущем планируется много дополнений, одни из них: сохранение истории принятых лекарств и журнал напоминалка, о приёме лекарств. Именно по этому на данный момент доступен только 1 пункт с аптечкой. \n\nЕсли у тебя есть идеи по доработке, обязательно пиши об этом в отзывах. Учту всё и постараюсь сделать по твоим пожеланиям.",
